                         ...
                         <div className='px-8 py-8'>
                             ...
                             <div>
                                 <form onSubmit={register} className='text-slate-600'>
                                     ...
                                     <button className='px-8 w-full py-2 bg-[#059473] shadow-lg hover:shadow-green-500/40 text-white rounded-md'>Register</button>                                 </form>
                             ...
                             <a target='_blank' href="http://localhost:3000/login">
                              <div className='px-8 w-full py-2 bg-[#345f5e] shadow hover:shadow-red-500/50 text-white rounded-md flex justify-center items-center gap-2 mb-3'>
                                Login As a Seller
                            </div>
                            </a>
