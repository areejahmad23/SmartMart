                ...
                <div className="w-[90%] sm:w-[80%] md:w-[70%] lg:w-[60%] xl:w-[50%] mx-auto">
                    <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col md:flex-row">
                        ...
                        <div className="w-full md:w-1/2 p-8">
                            <h2 className='text-2xl font-bold text-[#000033] text-center mb-6'>Login</h2> 
                            ...
                            <div className="text-center text-[#666] mt-6">
                                <p>Don't have an account? <Link to='/register' className="text-[#0077cc] hover:underline">Register</Link></p>
                            </div>
