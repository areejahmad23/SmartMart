        ...
        submit_review = async (req, res) => {
            ...
            try {
                await reviewModel.create({
                    ...
                    rating,
                    review,
                    date: moment(Date.now()).format('LL')  // Fixed incorrect parentheses
                });
                ...
                for (let i = 0; i < reviews.length; i++) {
                    rat = rat + reviews[i].rating;  // Fixed typo in `reviews`
                }
                ...
                res.status(201).json({ message: 'Review Added Successfully' });  // Fixed response format
...
try {
   ...
   responseReturn(res, 200, {
    reviews,
    totalReview: getAll.length,      //check on frontend if spellings are wrong!!!
    rating_review     
   })
