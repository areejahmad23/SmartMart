        ...
        <div className='px-2 lg:px-7 pt-5'>
            <div className='w-full p-4 bg-[#ffffff] rounded-md shadow-lg'>
                <div className='flex justify-between items-center p-4'>
                    ...
                    <select onChange={status_update} value={status} name="" id="" className='px-4 py-2 focus:border-[#0077cc] outline-none bg-[#ffffff] border border-[#0077cc] rounded-md text-[#000000]'>
                    ...
                    <div className='flex flex-wrap'>
                        <div className='w-[30%]'>
                            <div className='pr-3 text-[#000000] text-lg'>
                                ...
                                <div className='mt-4 flex flex-col gap-4 bg-[#f8f9fa] rounded-md p-4'>
