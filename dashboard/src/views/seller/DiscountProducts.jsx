                                ...
                                [1, 2, 3, 4, 5].map((d, i) => (
                                    <tr key={i} className='hover:bg-[#f8f9fa] transition-all duration-200'>
                                        ...
                                        <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                                            <img className='w-[45px] h-[45px] rounded-md' src={`http://localhost:3001/images/category/${d}.jpg`} alt="" />
                                        </td>
                                        ...
                                        <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                                            <div className='flex justify-start items-center gap-4'>
                                                <Link className='p-[6px] bg-[#0077cc] rounded hover:shadow-lg hover:shadow-[#0077cc]/50'>
